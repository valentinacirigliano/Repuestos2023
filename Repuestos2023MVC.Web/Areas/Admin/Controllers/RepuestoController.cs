...
namespace Repuestos2023MVC.Web.Areas.Admin.Controllers
{
    ...
    public class RepuestoController : Controller
    {
        ...
        public IActionResult Edit(int? id)
        {
            ...
            var repuesto = _unitOfWork.Repuestos.Get(c => c.RepuestoId == id);
            if (repuesto == null)
            {
                return NotFound();
            }
        ...
        public IActionResult Edit(Repuesto repuesto)
        {
            ...
            {
                ModelState.AddModelError(string.Empty, "El repuesto ya existe");
                return View(repuesto);
            }
            _unitOfWork.Repuestos.Update(repuesto);
            _unitOfWork.Save();
            TempData["success"] = "Registro guardado exitosamente";
        ...
        {
            var repuesto = _unitOfWork.Repuestos.GetById(id);
            return View(repuesto);
        }
        ...
        public IActionResult GetAll()
        {
            ...
            foreach (var repuesto in repuestoList)
            {
                var repuestoVm = new RepuestoListVm()
                {
                    ...
                    Categoria = repuesto.Categoria.NombreCategoria,
